...
import com.yatai.suningfiredepartment.view.activity.DocumentActivity;
...
//    HomePlaceAdapter mHomePlaceAdapter;//重点区域
//    HomePeopleAdapter mHomePeopleAdapter;//重点人群
        ...
        mHomeCategoryAdapter.setListener(new HomeCategoryAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                switch (categoryList.get(position).getType()){
                    //消防公约
                    case 1:
                        Intent intentDocument = new Intent(getActivity(),DocumentActivity.class);
                        intentDocument.putExtra("documentId",categoryList.get(position).getId());
                        startActivity(intentDocument);
                        break;
                    case 2://重点人群
                        Intent intentPeople = new Intent(getActivity(),FocusGroupActivity.class);
                        Gson gson =new Gson();
                        intentPeople.putExtra("gridId",gridId);
                        startActivity(intentPeople);
                        break;
                    case 3://重点单位
                        Intent intentPlace = new Intent(getActivity(),FocusPlaceActivity.class);
                        intentPlace.putExtra("gridId",gridId);
                        startActivity(intentPlace);
                        break;
                    case 4://任务
                        Intent intentCategory = new Intent(getActivity(), SubWorkActivity.class);
